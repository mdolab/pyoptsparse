...
*     31 Mar 2005: Current version of snOpt.
*     ==================================================================
      external
...
*     ------------------------------------------------------------------
     ...
     &     nnCon, nnObj, nnJac,
     &     iObj, ObjAdd, Prob,
     &     fgcon, fgobj, snLog, snLog2, sqLog, snSTOP,
     &     Jcol, indJ, locJ, bl, bu, Names,
     &     hs, x, pi, rc,
     &     INFO, mincw, miniw, minrw,
     &     nS, nInf, sInf, Obj,
...
*     24 Dec 2002: Current version of snOptB.
*     ==================================================================
      external
     &     snLog, snLog2, sqLog, snSTOP
*     ------------------------------------------------------------------
...
*     17 Oct 2004: Current version of snKerB.
*     ==================================================================
      character
     ...
     &     FPonly, gotR, PrtMem
      integer
     &     Errors, Htype, inform, lenR, lenx0, lgObj, lhElas,
     ...
     &     nlocJ, nMajor, nnH, nnH0, nrhs, nrhs0, nx0
      double precision
...
*        The problem is a linear program.
         ...
         lgObj  = iw(296)      ! gObj(ngObj) = Objective gradient
